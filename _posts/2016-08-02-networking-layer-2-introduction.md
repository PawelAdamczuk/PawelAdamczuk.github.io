---
title: 'Networking layer 2 on Cisco devices'
---
...
![](/assets/2016-08-02-networking-layer-2-introduction/2.png)
...
```js
>enable //this enables the privileged mode
...
>exit
>copy running-config startup-config //saves the current configuration as the startup configuration
```

Packet Tracer lets you export and import the device's configuration to and from your hard drive. You can download the switch configuration file [here](/assets/2016-08-02-networking-layer-2-introduction/mSwitch0_startup-config.txt). Keep in mind that any changes you make in the configuration menu are being saved in the running configuration only. They will be lost when you reboot the device, unless you save the running configuration as startup configuration using the last one of the commands listed above.
...
![](/assets/2016-08-02-networking-layer-2-introduction/3.jpg)
...
![](/assets/2016-08-02-networking-layer-2-introduction/4.jpg)
*There are new entries in the table*
...
![](/assets/2016-08-02-networking-layer-2-introduction/5.png)
*The ICMP frame*
...
![](/assets/2016-08-02-networking-layer-2-introduction/6.png)
...
![](/assets/2016-08-02-networking-layer-2-introduction/7.png)
*Poor ping results*
...
![](/assets/2016-08-02-networking-layer-2-introduction/8.png)
*Both ports are working in full-duplex mode*
...
![](/assets/2016-08-02-networking-layer-2-introduction/9.png)
*Better ping results on the switched network segment*
...
<em>I am not a networking expert - if you notice any errors in the article, please send me an e-mail.</em>